    ...
    <div className="login">
      ...
      <div className="login-container">
        ...
        <form>
          ...
          <div className="input-container">
            <p className="text-over-input">
              Please enter the email that you will connect to your account
            </p>
            <input
              value={email}
          ...
          <div className="input-container">
            <p className="text-over-input">
              Please a password for your account
            </p>
            <input
              value={password}
          ...
          <div className="input-container">
            <p className="text-over-input">Please confirm your password</p>
            <input
              value={passwordCheck}
        ...
        <p>
          ...
          <span className="login__register" onClick={login}>
            Login
          </span>
        </p>
      </div>
